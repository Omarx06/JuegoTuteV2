...
public class Canvas
{
    ...
    public void setForegroundColor(String colorString)
    {
        if(colorString.equals("red")) {
            ...
            graphic.setColor(new Color(255, 127, 39));
        }
        else if(colorString.equals("lime")) {
            graphic.setColor(new Color(181, 230, 29));
        }
        else if(colorString.equals("pink")) {
            graphic.setColor(new Color(255, 174, 201));
        }
        else if(colorString.equals("purple")) {
            graphic.setColor(new Color(163, 73, 164));
        }
        else if(colorString.equals("brown")) {
            graphic.setColor(new Color(120, 67, 21));
        }
